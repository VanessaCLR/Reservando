class Listado {
    ...
    calificarRestaurant(id, calificacion) {
        //Busca el objeto que posee el id dado
        let restaurant = this.buscarRestaurante(id);
    ...
    buscarRestaurante(id) {
       ...
       let busqueda = this.restaurantes.find(restaurantes => restaurantes.id ===  id); 
       return busqueda;
    }
    ...
    obtenerUbicaciones() {
        ...
        let c = restaurantes.map(restaurantes => restaurantes.ubicacion);
    ...
    obtenerRubros() {
        let restaurantes = this.restaurantes;
        let r = restaurantes.map(restaurantes => restaurantes.rubro);
    ...
    obtenerHorarios() {
        ...
        let restaurantes = this.restaurantes;
        let arregloH = restaurantes.map(restaurantes => restaurantes.horarios);;
